...
<body>
	...
	<div id="page-wrapper">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12">
					<form:form action="add-client.html" commandName="client" method="POST">

						<form:hidden path="id" />
						<form:label path="nom">
							<spring:message code="name" />
						</form:label>
						<form:input class="form-control" placeholder="Name" path="nom"
							id="nom" />
						...
						<p />
						<input type="submit" value="<spring:message code="validate" />" class="btn btn-default" />
						<a href="list-clients.html" class="btn btn-default">
