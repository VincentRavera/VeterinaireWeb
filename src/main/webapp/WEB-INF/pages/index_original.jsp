            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="list-animals.html">
                            	<i class="fa fa-paw fa-fw"></i>
                            	<spring:message code="animals" />
                            </a>
                        </li>
                        <li>
                            <a href="list-clients.html"><i class="fa fa-child fa-fw"></i>
                            	<spring:message code="clients" />
                            <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="list-clients.html">
                                    	<spring:message code="by.name" />
                                    </a>
                                </li>
                                <li>
                                    <a href="list-clients.html">
                                    <spring:message code="by.fname" />
                                    </a>
                                </li>
                                <li>
                                    <a href="list-animals.html">
                                    <spring:message code="by.animal" />
                                    </a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        ...
                        <li>
                            <a href="list-adresse.html">
                            <i class="fa fa-university  fa-fw"></i>
                            <spring:message code="address" />
                            </a>
                        </li>
                        <li>
                            <a href="list-vaccins.html">
